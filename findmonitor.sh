...
xrandr --verbose | edid-decode | grep "Manufacturer" | xargs >> /home/$USER/Desktop/monitor.tex
echo "\newline" >> /home/$USER/Desktop/monitor.tex
xrandr --verbose | edid-decode | grep "Product Name" >> /home/$USER/Desktop/monitor.tex
echo "\newline" >> /home/$USER/Desktop/monitor.tex
xrandr --verbose | edid-decode | grep "Product Serial Number:" >> /home/$USER/Desktop/monitor.tex
echo "\newline" >> /home/$USER/Desktop/monitor.tex
# xrandr | grep " connected" | cut -c 18-  >> /home/$USER/Desktop/monitor.tex
#xrandr | grep " connected" | xargs >> /home/$USER/Desktop/monitor.tex
xrandr | grep " connected" |sed -n -e 's/^.*connected //p' | xargs >> /home/$USER/Desktop/monitor.tex
echo "\newline" >> /home/$USER/Desktop/monitor.tex
case $SHORTMFG in
	HWP)
		echo -n "HP"  >> /home/$USER/Desktop/monitor.tex >> /home/$USER/Desktop/monitor.tex
		;;
	GSM)
		echo -n "LG"  >> /home/$USER/Desktop/monitor.tex >> /home/$USER/Desktop/monitor.tex
		;;
	SAM)
		echo -n "Samsung" >> /home/$USER/Desktop/monitor.tex >> /home/$USER/Desktop/monitor.tex
		;;
	VSC)
		echo -n "ViewSonic" >> /home/$USER/Desktop/monitor.tex >> /home/$USER/Desktop/monitor.tex
		;;
	LEN)
		echo -n "Lenovo" >> /home/$USER/Desktop/monitor.tex >> /home/$USER/Desktop/monitor.tex
		;;
	VIT)
		echo -n "3M" >> /home/$USER/Desktop/monitor.tex >> /home/$USER/Desktop/monitor.tex
		;;
	DEL)
		echo -n "Dell" >> /home/$USER/Desktop/monitor.tex >> /home/$USER/Desktop/monitor.tex
		;;
	NEC)
		echo -n "NEC" >> /home/$USER/Desktop/monitor.tex >> /home/$USER/Desktop/monitor.tex
		;;
	ACI)
		echo -n "ASUS" >> /home/$USER/Desktop/monitor.tex >> /home/$USER/Desktop/monitor.tex
		;;
	AOC)
		echo -n "AOC" >> /home/$USER/Desktop/monitor.tex >> /home/$USER/Desktop/monitor.tex
		;;
	ACR)
		echo -n "Acer" >> /home/$USER/Desktop/monitor.tex >> /home/$USER/Desktop/monitor.tex
		;;
	BNQ)
		echo -n "BenQ" >> /home/$USER/Desktop/monitor.tex >> /home/$USER/Desktop/monitor.tex
		;;
	*)
